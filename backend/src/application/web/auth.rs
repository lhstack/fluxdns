...
use crate::application::web::error::ApiError;
use crate::infrastructure::common::error::AppError;
...
pub async fn login_handler(
    ...
    Ok(Json(state.auth_service.login(&request)?))
}
...
mod tests {
    use super::*;
    use crate::infrastructure::config::PartialConfig;

//! Web adapter
//!
//! Axum routing, request/response DTOs and HTTP error mapping. Handlers only
//! adapt input and output; orchestration lives in the business layer.
...
pub use auth::{auth_middleware, AuthService, AuthState};
...
pub use records::{records_router, RecordsState};
